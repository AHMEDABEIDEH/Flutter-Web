...
class navBarContents extends StatefulWidget {
  navBarContents();

  @override
  _navBarContentssState createState() => _navBarContentssState();
}

class _navBarContentssState extends State<navBarContents> {
